...
//   }
// });
app.post('/face-similarity', upload.fields([{ name: 'image1' }, { name: 'image2' }]), async (req, res) => {
  ...
  try {
      ...
      if (!detections1 || !detections2) {
          return res.status(400).json({ message: 'No faces detected in one or both images' });
      }
